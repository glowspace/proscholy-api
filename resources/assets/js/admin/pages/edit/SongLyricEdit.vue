  ...
  <v-app :dark="$root.dark">
    ...
    <v-container fluid grid-list-xs>
            ...
            <v-layout row wrap class="pt-2">
              <v-flex xs12 md6>
                ...
                <v-textarea
                  ...
                  ref="textarea"
                  :readonly="model.lilypond == null || model.lilypond.length === 0"
      ...
      <div class="position-sticky fixed-bottom body-bg mb-0 p-2 card d-inline-block overflow-auto" style="max-height:15vh;z-index:0; max-width: 90vw;">
        ...
        <v-btn v-if="model_database && model_database.public_url" :href="model_database.public_url + '-' + Math.random().toString(36).substring(3)" class="ml-0" target="_blank" icon><i class="fas fa-external-link-alt"></i></v-btn>
