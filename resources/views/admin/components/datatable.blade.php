...
@pushonce('scripts:datatable')
    ...
    <script>
        ...
        renderer:"bootstrap"});a.extend(d.ext.classes,{sWrapper:"dataTables_wrapper dt-bootstrap4 mb-4",sFilterInput:'form-control" style="height:2rem',sLengthSelect:'custom-select custom-select-sm form-control form-control-sm px-1',sProcessing:"dataTables_processing card",sPageButton:"paginate_button page-item"});d.ext.renderer.pageButton.bootstrap=function(b,l,v,w,m,r){var k=new d.Api(b),x=b.oClasses,n=b.oLanguage.oPaginate,y=b.oLanguage.oAria.paginate||{},g,h,t=0,u=function(c,d){var e,l=function(b){b.preventDefault();
