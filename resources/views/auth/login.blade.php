...
@section('content')
    <div class="center-container">
        <div>
            <div class="card text-white bg-info mb-3" style="max-width: 500px; width: 100%;">
                <div class="card-body">
                    <p class="card-text">Dál už můžeme jenom my, redaktoři ProScholy.cz. Chceš se stát jedním z nás? Napiš na redakce@proscholy.cz.</p>
                </div>
            </div>
